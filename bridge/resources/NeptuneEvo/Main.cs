...
namespace NeptuneEvo
{
    ...
    { 
        public static string Codename { get; } = "TalRasha-Refix";
        ...
        public static void payDayTrigger()
        {
            NAPI.Task.Run(() =>
            {
                try
                {
                    ...
                    int biz_id = rand.Next(0, 10);
                    BusinessManager.BizList[biz_id].CreateRob();
                        ...
                        try
                        {
                            ...
                            switch (Fractions.Manager.FractionTypes[Players[player].FractionID])
                            {
                                ...
                                case 1:
                                    ...
                                    NAPI.Chat.SendChatMessageToPlayer(player, $"Начато ограбление бизнес");
                                    break;
                                case 2:
