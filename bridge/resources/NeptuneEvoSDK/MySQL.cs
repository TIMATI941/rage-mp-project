...
namespace Redage.SDK
{
    public static class MySQL
    {
        ...
        public static void Init()
        {
            ...
            Connection = 
                $"Host={config.TryGet<string>("Server", "95.181.152.171")};" +
                $"User={config.TryGet<string>("User", "gs60")};" +
                $"Password={config.TryGet<string>("Password", "np0S1LsbU9")};" +
                $"Database={config.TryGet<string>("DataBase", "gs60")};" +
